...
// Dynamically import react-konva to avoid "Cannot access before initialization" in production
...
export default function MoodboardPage() {
  ...
  // Load react-konva dynamically to prevent initialization issues in production
  useEffect(() => {
    loadKonva()
      .then(() => {
        setKonvaLoaded(true)
