...
const translations = {
  en: {
    ...
    overnightStayNote: 'Note: Accommodation and overnight stay are self-paid.',
    select: 'Select...',
  ...
  de: {
    ...
    overnightStayNote: 'Hinweis: Unterkunft und Übernachtung sind selbst zu zahlen.',
    select: 'Auswählen...',
  ...
  fr: {
    ...
    overnightStayNote: 'Note: L\'hébergement et le séjour de nuit sont à payer par vous-même.',
    select: 'Sélectionner...',
